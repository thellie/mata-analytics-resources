 ...
 * @generated */
public class OpinionPhraseLevel2_Type extends Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.mata.genanno.OpinionPhraseLevel2");
 
  /** @generated */
  final Feature casFeat_not1;
  /** @generated */
  final int     casFeatCode_not1;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public String getNot1(int addr) {
        if (featOkTst && casFeat_not1 == null)
      jcas.throwFeatMissing("not1", "com.mata.genanno.OpinionPhraseLevel2");
    return ll_cas.ll_getStringValue(addr, casFeatCode_not1);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setNot1(int addr, String v) {
        if (featOkTst && casFeat_not1 == null)
      jcas.throwFeatMissing("not1", "com.mata.genanno.OpinionPhraseLevel2");
    ll_cas.ll_setStringValue(addr, casFeatCode_not1, v);}
    
  
 
  /** @generated */
  final Feature casFeat_not2;
  /** @generated */
  final int     casFeatCode_not2;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public String getNot2(int addr) {
        if (featOkTst && casFeat_not2 == null)
      jcas.throwFeatMissing("not2", "com.mata.genanno.OpinionPhraseLevel2");
    return ll_cas.ll_getStringValue(addr, casFeatCode_not2);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setNot2(int addr, String v) {
        if (featOkTst && casFeat_not2 == null)
      jcas.throwFeatMissing("not2", "com.mata.genanno.OpinionPhraseLevel2");
    ll_cas.ll_setStringValue(addr, casFeatCode_not2, v);}
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "com.mata.genanno.OpinionPhraseLevel2");
  ...
  public String getPolarity(int addr) {
      ...
      jcas.throwFeatMissing("polarity", "com.mata.genanno.OpinionPhraseLevel2");
  ...
  public String getSentimentMatch(int addr) {
      ...
      jcas.throwFeatMissing("sentimentMatch", "com.mata.genanno.OpinionPhraseLevel2");
  ...
  public String getSentimentTerm(int addr) {
      ...
      jcas.throwFeatMissing("sentimentTerm", "com.mata.genanno.OpinionPhraseLevel2");
  ...
  public String getRuleName(int addr) {
      ...
      jcas.throwFeatMissing("ruleName", "com.mata.genanno.OpinionPhraseLevel2");
  ...
  public String getRuleId(int addr) {
      ...
      jcas.throwFeatMissing("ruleId", "com.mata.genanno.OpinionPhraseLevel2");
  ...
  public OpinionPhraseLevel2_Type(JCas jcas, Type casType) {
    ...
    casFeat_not1 = jcas.getRequiredFeatureDE(casType, "not1", "uima.cas.String", featOkTst);
    casFeatCode_not1  = (null == casFeat_not1) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_not1).getCode();

 
    casFeat_not2 = jcas.getRequiredFeatureDE(casType, "not2", "uima.cas.String", featOkTst);
    casFeatCode_not2  = (null == casFeat_not2) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_not2).getCode();
