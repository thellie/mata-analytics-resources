 ...
 * @generated */
public class Date_Type extends DictionaryEntryAnnotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.mata.genanno.Date");
  ...
  public String getRuleId(int addr) {
      ...
      jcas.throwFeatMissing("ruleId", "com.mata.genanno.Date");
