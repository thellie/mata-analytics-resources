 ...
 * @generated */
public class NameParse_Type extends Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.mata.genanno.NameParse");
 
  /** @generated */
  final Feature casFeat_nameparse;
  /** @generated */
  final int     casFeatCode_nameparse;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public String getNameparse(int addr) {
        if (featOkTst && casFeat_nameparse == null)
      jcas.throwFeatMissing("nameparse", "com.mata.genanno.NameParse");
    return ll_cas.ll_getStringValue(addr, casFeatCode_nameparse);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setNameparse(int addr, String v) {
        if (featOkTst && casFeat_nameparse == null)
      jcas.throwFeatMissing("nameparse", "com.mata.genanno.NameParse");
    ll_cas.ll_setStringValue(addr, casFeatCode_nameparse, v);}
  ...
  public String getRuleId(int addr) {
      ...
      jcas.throwFeatMissing("ruleId", "com.mata.genanno.NameParse");
  ...
  public NameParse_Type(JCas jcas, Type casType) {
    ...
    casFeat_nameparse = jcas.getRequiredFeatureDE(casType, "nameparse", "uima.cas.String", featOkTst);
    casFeatCode_nameparse  = (null == casFeat_nameparse) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_nameparse).getCode();
