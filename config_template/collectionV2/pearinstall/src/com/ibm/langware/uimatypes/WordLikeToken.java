 ...
 * @generated */
public class WordLikeToken extends TokenAnnotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(WordLikeToken.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected WordLikeToken() {/* intentionally empty block */}
   ...
   */
  public WordLikeToken(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public WordLikeToken(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public WordLikeToken(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
