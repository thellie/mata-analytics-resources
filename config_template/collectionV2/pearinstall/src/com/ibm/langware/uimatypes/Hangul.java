 ...
 * @generated */
public class Hangul extends Syllabic {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Hangul.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Hangul() {/* intentionally empty block */}
   ...
   */
  public Hangul(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Hangul(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
