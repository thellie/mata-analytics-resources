 ...
 * @generated */
public class Han extends Ideographic {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Han.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Han() {/* intentionally empty block */}
   ...
   */
  public Han(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Han(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
